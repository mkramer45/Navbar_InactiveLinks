...
def Jazz():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612762')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Spurs():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612759')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Kings():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612758')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Suns():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612756')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Thunder():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612760')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Pelicans():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612740')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Timberwolves():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612750')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Grizzlies():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612763')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Lakers():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612747')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Clippers():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612746')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Rockets():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612745')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Warriors():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612744')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Nuggets():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612743')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
...
def Mavericks():
	g.db = connect_db2()
	cur2 = g.db.execute('select FirstName, LastName, College_Country, Height, Weight, Position, BirthDate from Players where teamid = 1610612742')
	info1 = [dict(FirstName=row[0], LastName=row[1], College_Country=row[2], Height=row[3], Weight=row[4], Position=row[5], BirthDate=row[6]) for row in cur2.fetchall()]
	g.db.close()
